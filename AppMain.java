...
class ApplicationLogin extends Template implements ActionListener, Runnable
{
   JButton SUBMIT;
   ...
   ApplicationLogin()
   {
    ...
    TopLabel.setText("File Packer Un-packer : Login ");
    ...
    SUBMIT.setBounds(220,220,ssize.width,ssize.height);
   ...
   public void actionPerformed(ActionEvent ae)
   {
	...
	if(ae.getSource() == SUBMIT)
	{
		...
		if(value1.equals("saurabhnale") && value2.equals("Patil/123"))  // Change this
		{
...
class AppMain
{
	public static void main(String args[])
	{
		...
		try
		{
			ApplicationLogin frame = new ApplicationLogin();
